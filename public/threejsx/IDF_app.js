...
init();
// idf_fetchAndReturnGeometry("../model.idf");
// let xxx = newFetch("../model.idf");

gui(); // millor crear aqui

// degut a la llogica fetch, nomes ho puc fer aixi...
// newFetch("../model_2.idf").then((result) => {
    newFetch("../public/model_2.idf").then((result) => {
...
// newFetch("../model.idf").then(result => idf_fullManageAndSceneAddObjects_windows(result));
